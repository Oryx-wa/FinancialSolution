...
<FormAttribute("OWA.SBO.FinSolnWinx.FctyApplication", "AddOnForms/FctyApplication.b1f")>
    ...
    Public Overrides Sub OnInitializeComponent()
        ...
        Me.EditText13 = CType(Me.GetItem("Item_27").Specific, SAPbouiCOM.EditText)
        ...
        Me.StaticText15 = CType(Me.GetItem("Item_30").Specific, SAPbouiCOM.StaticText)
        Me.EditText15 = CType(Me.GetItem("Item_31").Specific, SAPbouiCOM.EditText)
        Me.StaticText16 = CType(Me.GetItem("Item_32").Specific, SAPbouiCOM.StaticText)
        Me.EditText16 = CType(Me.GetItem("Item_33").Specific, SAPbouiCOM.EditText)
        Me.StaticText17 = CType(Me.GetItem("Item_34").Specific, SAPbouiCOM.StaticText)
        Me.EditText17 = CType(Me.GetItem("Item_35").Specific, SAPbouiCOM.EditText)
        Me.StaticText18 = CType(Me.GetItem("Item_36").Specific, SAPbouiCOM.StaticText)
        Me.ComboBox0 = CType(Me.GetItem("Item_37").Specific, SAPbouiCOM.ComboBox)
        Me.StaticText19 = CType(Me.GetItem("Item_38").Specific, SAPbouiCOM.StaticText)
        Me.EditText18 = CType(Me.GetItem("Item_39").Specific, SAPbouiCOM.EditText)
