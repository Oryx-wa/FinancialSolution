...
<body>
  ...
  <div id="w">
    <div id="content">
      ...
      <center><a href="#loginmodal" class="flatbtn" id="btnmember">Login as COOP Staff</a></center>
      <p></p>
      <center><a href="staff/login" class="flatbtn" id="btnauthorizer">Login As Authorizer</a></center>
      <p></p>
      <center><a href="staff/login" class="flatbtn" id="btnpos">Login to Point of Sale</a></center>
      <p></p>
      <center><a href="staff/login" class="flatbtn" id="btnsupport">Login to Support Staff</a></center>
